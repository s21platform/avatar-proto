...
type DeleteAvatarOut struct {
	...
	DeletedAvatar *Avatar `protobuf:"bytes,1,opt,name=deleted_avatar,json=deletedAvatar,proto3" json:"deleted_avatar,omitempty"`
}

func (x *DeleteAvatarOut) Reset() {
	*x = DeleteAvatarOut{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeleteAvatarOut) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteAvatarOut) ProtoMessage() {}

func (x *DeleteAvatarOut) ProtoReflect() protoreflect.Message {
	mi := &file_avatar_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteAvatarOut.ProtoReflect.Descriptor instead.
func (*DeleteAvatarOut) Descriptor() ([]byte, []int) {
	return file_avatar_proto_rawDescGZIP(), []int{6}
}

func (x *DeleteAvatarOut) GetDeletedAvatar() *Avatar {
	if x != nil {
		return x.DeletedAvatar
	}
	return nil
}
...
var file_avatar_proto_rawDesc = []byte{
	...
	,
...
var file_avatar_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_avatar_proto_goTypes = []any{
	...
	(*DeleteAvatarOut)(nil),  // 6: avatar.DeleteAvatarOut
}
var file_avatar_proto_depIdxs = []int32{
	3, // 0: avatar.GetAllAvatarsOut.avatar_list:type_name -> avatar.Avatar
	3, // 1: avatar.DeleteAvatarOut.deleted_avatar:type_name -> avatar.Avatar
	...
	1, // 5: avatar.AvatarService.SetAvatar:output_type -> avatar.SetAvatarOut
	4, // 6: avatar.AvatarService.GetAllAvatars:output_type -> avatar.GetAllAvatarsOut
	6, // 7: avatar.AvatarService.DeleteAvatar:output_type -> avatar.DeleteAvatarOut
...
func file_avatar_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_avatar_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*DeleteAvatarOut); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
